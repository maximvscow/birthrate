...
def get_posts(link):
    ...
    posts = list()
    wall = vk.wall.get(owner_id=int(owner), count=50, v=5.131)
...
if __name__ == "__main__":
    gr_urls = [r"https://vk.com/bad_novosti", r"https://vk.com/rhymes",
               r"https://vk.com/bot_maxim", r"https://vk.com/sci", r"https://vk.com/mudakoff"]
